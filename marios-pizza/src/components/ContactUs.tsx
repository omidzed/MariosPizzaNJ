...
export function ContactUs() {
	...
	const formStyle = 'flex p-4 m-2 md:my-8 md:p-8 flex-col bg-secondary rounded-md xl:mx-12 w-4/5 md:w-1/2';
		...
		<div className='w-full flex flex-col md:flex-row overflow-auto 100vh'>
			<div className='flex justify-center 100vh lg:w-2/3'>
				<form
					...
					<h2 className='text-white p-2 font-bold text-2xl xl:mb-4 whitespace-nowrap'>Contact Form</h2>
			...
			<div className='flex flex-col mx-16 lg:w-1/2 justify-center gap-2 p-6 text-xl  md:text-3xl lg:text-5xl w-1/3 md:w-1/2'>
				<span className='md:mb-6 whitespace-nowrap text-2xl md:text-3xl lg:text-4xl mb-1'>Contact Details</span>
